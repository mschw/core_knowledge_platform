...
<publication xmlns="http://test/"
    ...
    <owner>
        <atom:link rel="owner" type="application/xml" href="http://test/user/%s">some</atom:link>
    </owner>
    <authors>    
        <author>
            <atom:link rel="author" type="application/xml" href="http://test/author/%s">Some name</atom:link>
        </author>
    </authors>
    <comments>    
        <comment>
            <atom:link rel="comment" type="application/xml" href="http://test/comment/%s">Some title</atom:link>
        </comment>
    </comments>
    <tags>
        <tag>
            <atom:link rel="tag" type="application/xml" href="http://test/tag/%s">Some tag</atom:link>
        </tag>
    </tags>
    <referencematerials>
        <referencematerial>
