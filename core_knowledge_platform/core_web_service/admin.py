...
from core_web_service.models import Author, Vote, Tag, Comment, Esteem, Keyword, Publication, FurtherField, PeerReviewTemplate, PeerReview, ProfileField, Rating, ReferenceMaterial
