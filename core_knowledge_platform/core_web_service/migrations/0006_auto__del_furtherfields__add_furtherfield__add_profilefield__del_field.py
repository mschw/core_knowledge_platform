...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserProfile.further_fields'
        db.delete_column('core_web_service_userprofile', 'further_fields_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'UserProfile.further_fields'
        db.add_column('core_web_service_userprofile', 'further_fields', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core_web_service.FurtherFields']), keep_default=False)
